...
class Plateau{
    ...
    public Plateau() throws ErreurCoordonneesException
	{
	...
	if(!aDeplacer.getDeplacementPossible(this).contains(to)){
	    throw new CaseOccupeeException(aDeplacer);
	}
    ...
    public void deplacer(String from, String to) throws ErreurCoordonneesException
	{
	this.deplacer(new Position(from), new Position(to));
    }

    public void deplacer(int xf, int yf, int xt, int yt) throws ErreurCoordonneesException
	{
